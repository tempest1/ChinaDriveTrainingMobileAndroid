package com.smartlab.drivetrain.pullable;

/**
 * Created by zhoudi on 16/3/23.
 */
...
public class TimeButton extends Button implements OnClickListener {
        private long lenght = 60 * 1000;// 倒 计时长度,这里给了默认60秒
        ...
        public void onCreate(Bundle bundle) {
            ...
            if (MainApplication.map == null)
                return;
            if (MainApplication.map.size() <= 0)// 这里表示没有上次未完成的计时
                return;
