 ...
 * 输入手机号码
 */
public class StepPhone extends RegisterStep implements TextWatcher,ActionCallBackListener<Void>,View.OnClickListener{
    /**
     * 中国国家编码
     */
    ...
    public StepPhone(Register activity, View content) {
    ...
    @Override
    public void doNext() {
        //activity.getAppAction().validPhone("validPhone", mPhone, Params.validPhone, this);
        mIsChange = false;
    ...
    public boolean validate() {
        ...
        if (TextUtils.isEmpty(response_code)){
            ...
            if (response_code.equals(msg_code)) {
                LogUtils.i(msg_code);
                return true;
            } else {
